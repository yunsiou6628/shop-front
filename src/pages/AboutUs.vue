    ...
    <div class="gt-lg">
      ...
      <div class="row q-px-xxxl" style="background: #fff; color: #5E8A4B;">
        ...
        <div class="row justify-center q-ma-lg q-my-xl  q-px-xl" style="width: 100%;">
          ...
          <div class="col-6 q-pa-xl">
            <div class="text-h6 text-weight-bolder q-ma-lg text-center">
              <span>愛上山林的瞬間</span>
            </div>
            <!-- 分隔線 -->
            ...
            <div class="text-subtitle1 column justify-center q-py-sm q-px-sm" style="line-height: 200%;">
      ...
      <div class="row q-px-xxxl" style=" background: #F4F8EE; color: #5E8A4B;">
        ...
        <div class="row justify-center q-ma-lg q-px-xl" style="width: 100%;">
          ...
          <!-- 文字 -->
          <div class="col-6 q-pa-xl">
            <div class="text-h6 text-weight-bolder q-ma-lg q-pt-md text-center">
              <span>帶你去爬山</span>
            </div>
            <!-- 分隔線 -->
            <div class="col-12 row justify-center q-pb-lg">
            ...
            <div class="text-subtitle1 q-py-sm q-px-sm">
              <span class="text-weight-bolder" style="line-height: 200%;">
                想和你/妳一起走進山裡，帶著屬於你/妳的山林故事與最珍貴的回憶出來。<br><br>
                在山上可以展現一個人最真實的樣子，你可以在山上看到最美、最動人的風景，也可以在山上體會到最折磨人、最痛苦的旅程。<br><br>
                這個過程可以好好的和自己對話，好好地問自己，你為什麼在這裡？你在找尋什麼？不管是追逐何者，不變的是你可以好好的認識自己。<br><br>
                來吧，來山裡吧！<br>
